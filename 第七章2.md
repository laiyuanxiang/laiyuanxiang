...
在 Mindloom 的执行体系中，AI 被定义为一种 **执行能力（Execution Capability）**。  
AI 不参与流程结构的定义，也不直接控制执行路径，而是通过 **Generator 执行器** 参与系统执行。

Agent 的执行能力可以抽象为以下四类：

| 能力类型 | 单元 | 作用 |
|---|---|---|
| 结构控制 | Process | 定义流程结构、分支、循环、并行等逻辑 |
| AI认知 | Generator | 语义判断与内容生成 |
| 系统能力 | Tool | 通用系统功能，如时间、存储、格式处理等 |
| 现实交互 | Action | 与外部系统或现实世界进行交互 |
...
Generator[Generator<br>AI认知]

Tool[Tool<br>系统能力]

Action[Action<br>现实交互]
